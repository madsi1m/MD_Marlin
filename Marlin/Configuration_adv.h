...
#define FAN_KICKSTART_TIME 800 //MD 100 //MD uncomment
...
#define QUICK_HOME //MD uncomment                         // If G28 contains XY do a diagonal move first
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 400 //MD 500
...
#define DEFAULT_STEPPER_DEACTIVE_TIME 60 //MD 120
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //MD uncommented
...
#define LCD_DECIMAL_SMALL_XY //MD uncommented

// The timeout (in ms) to return to the status screen from sub-menus
//#define LCD_TIMEOUT_TO_STATUS 15000

// Add an 'M73' G-code to set the current percentage
#define LCD_SET_PROGRESS_MANUALLY //MD uncommented
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define PRINT_PROGRESS_SHOW_DECIMALS //MD uncommented // Show progress with decimal digits
  #define SHOW_REMAINING_TIME //MD uncommented          // Display estimated time to completion

  #if ENABLED(SHOW_REMAINING_TIME)
    #define USE_M73_REMAINING_TIME //MD uncommented     // Use remaining time from M73 command instead of estimation
    #define ROTATE_PROGRESS_DISPLAY //MD uncommented    // Display (P)rogress, (E)lapsed, and (R)emaining time
  #endif
#endif
  ...
  #define LONG_FILENAME_HOST_SUPPORT //MD uncommented
 ...
 */
  ...
  // Western only. Not available for Cyrillic, Kana, Turkish, Greek, or Chinese.
  #define USE_SMALL_INFOFONT //MD uncommented
  ...
  #define STATUS_ALT_BED_BITMAP //MD uncommented    // Use the alternative bed bitmap
  #define STATUS_ALT_FAN_BITMAP //MD uncommented    // Use the alternative fan bitmap
  #define STATUS_FAN_FRAMES 4 //MD uncommented+3    // :[0,1,2,3,4] Number of fan animation frames
...
#define BABYSTEPPING
  ...
  #define BABYSTEP_ZPROBE_OFFSET //MD uncommented          // Combine M851 Z and Babystepping
  #if ENABLED(BABYSTEP_ZPROBE_OFFSET)
    //#define BABYSTEP_HOTEND_Z_OFFSET      // For multiple hotends, babystep relative Z offsets
    #define BABYSTEP_ZPROBE_GFX_OVERLAY //MD uncommented  // Enable graphical overlay on Z-offset editor
  #endif
#endif
 ...
 */
#define LIN_ADVANCE //MD uncommented
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0 //MD 0.22    // Unit: mm compression per 1mm/s extruder speed
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE //MD uncomment // Enable this option to permit S-Curve Acceleration
#endif
 ...
 */
  ...
  #define MIN_PROBE_EDGE_LEFT  MIN_PROBE_EDGE +44 //MD //taken from NOZZLE_TO_PROBE_OFFSET
  #define MIN_PROBE_EDGE_RIGHT MIN_PROBE_EDGE +44 //MD
  #define MIN_PROBE_EDGE_FRONT MIN_PROBE_EDGE  +4 //MD
  #define MIN_PROBE_EDGE_BACK  MIN_PROBE_EDGE  +4 //MD
#endif
 ...
 */
#define G29_RETRY_AND_RECOVER //MD uncomment
...
#define BEZIER_CURVE_SUPPORT //MD uncommented
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g. 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 32 //MD 8
#elif ENABLED(SDSUPPORT)
  #define BLOCK_BUFFER_SIZE 32 //MD 16
#else
  #define BLOCK_BUFFER_SIZE 32 //MD 16
#endif
 ...
 */
#define ADVANCED_PAUSE_FEATURE //MD uncommented
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS // MD uncomment
  ...
  #define E0_HYBRID_THRESHOLD  10000 //MD  30
   ...
   */
  #define SQUARE_WAVE_STEPPING //MD uncommented

  /**
   * Enable M122 debugging command for TMC stepper drivers.
   * M122 S0/1 will enable continous reporting.
   */
  #define TMC_DEBUG //MD uncommented
...
#define GCODE_CASE_INSENSITIVE  //MD uncommented  // Accept G-code sent to the firmware in lowercase
 ...
 */
//#define GCODE_MACROS //MD Doesn't work properly
 ...
 */
#define CANCEL_OBJECTS //MD uncommented
